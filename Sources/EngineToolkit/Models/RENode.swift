...
public extension RENode {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .bucket(let identifier):
            try container.encode(identifier, forKey: .identifier)
        case .proof(let identifier):
            try container.encode(identifier, forKey: .identifier)
            
        case .authZoneStack(let identifier):
        ...
        case .global(let identifier):
            try container.encode(identifier, forKey: .identifier)
        case .keyValueStore(let identifier):
            try container.encode(identifier, forKey: .identifier)
        case .nonFungibleStore(let identifier):
            try container.encode(identifier, forKey: .identifier)
        case .component(let identifier):
            try container.encode(identifier, forKey: .identifier)
        case .epochManager(let identifier):
            try container.encode(identifier, forKey: .identifier)
        case .vault(let identifier):
            try container.encode(identifier, forKey: .identifier)
        case .resourceManager(let identifier):
            try container.encode(identifier, forKey: .identifier)
