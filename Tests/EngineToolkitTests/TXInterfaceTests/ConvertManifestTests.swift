    ...
    func test__convertManifest_any_value_succeeds() throws {
        let manifestString = """
            ...
            CALL_METHOD
                ...
                Decimal("1.2")
                PreciseDecimal("1.2")
                NonFungibleId("5c200721031b84c5567b126440995d3ed5aaba0565d71e1834604819ff9c17f5e9d5dd078f");
            """;
        ...
        let expectedManifest = try TransactionManifest {
            ...
            try CallMethod(
                ...
                // Other interpreted types
                Expression("ALL_WORKTOP_RESOURCES")
                try NonFungibleAddress(hex: "00ed9100551d7fae91eaf413e50a3c5a59f8b96af9f1297890a8f45c200721031b84c5567b126440995d3ed5aaba0565d71e1834604819ff9c17f5e9d5dd078f")
                ...
                PreciseDecimal("1.2")
                try NonFungibleId(hex: "5c200721031b84c5567b126440995d3ed5aaba0565d71e1834604819ff9c17f5e9d5dd078f")
            }
        }
