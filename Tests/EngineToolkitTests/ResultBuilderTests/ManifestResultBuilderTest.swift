...
final class ManifestResultBuilderTest: TestCase {
    func test__complex_resultBuilded() throws {
        ...
        let built = TransactionManifest {
            ...
            CallMethod(componentAddress: "account_sim1q02r73u7nv47h80e30pc3q6ylsj7mgvparm3pnsm780qgsy064", methodName: "deposit_batch", arguments: [
            ...
            CallMethod(componentAddress: "component_sim1q2f9vmyrmeladvz0ejfttcztqv3genlsgpu9vue83mcs835hum", methodName: "complicated_method", arguments: [
                .decimal(1), .preciseDecimal(2)
            ])
        }
